...
%\begin{comment}
\begin{longtable}{|l|l|}
\caption[Overview of the default Nerfacto model's parameters]{An overview of the parameters in the default Nerfacto model. Rows prefixed with \textit{DF} describe the model's corresponding \textit{Density Fields}.} \label{tab:nerfacto-parameter-overview} \\
...
\begin{longtable}{|l|l|}
\caption[Overview of the default Nerfacto-big model's parameters]{An overview of the parameters in the Nerfacto-big model. Rows prefixed with \textit{DF} describe the model's corresponding \textit{Density Fields}.} \label{tab:nerfacto-big-parameter-overview} \\
...
\hline
Segment 1 & 24.960262 & 0.815270 &\cellcolor{green} 0.161623 \\
Segment 2 &\cellcolor{green} 25.660400 &\cellcolor{green} 0.824085 & 0.164296 \\
Segment 3 & 23.914209 &\cellcolor{red} 0.755183 & 0.194245 \\
Segment 4 &\cellcolor{red} 23.363695 & 0.764547 &\cellcolor{red} 0.216242 \\
\hline
\end{tabular}
...
\hline
\end{tabular}
\caption[Full results for experiment 4: Block-NeRF on 12-segment dataset]{Results for each segment when the larger segment spanning approximately 1.2km has been split into 12 Block-NeRFs.}
...
COLMAP w/o optimizer          &\cellcolor{green} 20.990921 & 0.757042 & 0.467530 & 00:10:25 \\
COLMAP w/ optimizer, 4 BNs    & 20.365336 & 0.75952125 & 0.427666 & 00:10:25 \\
COLMAP w/o optimizer, 4 BNs   & 20.45474375 &\cellcolor{green} 0.761062 &\cellcolor{green} 0.4253 & 00:10:25 \\
...
GPS w/o optimizer, 4 BNs      &\cellcolor{red} 14.578463 &\cellcolor{red} 0.6671365 &\cellcolor{red} 0.65638525 & 00:00:00 \\
\hline
\end{tabular}
\caption[Full results for experiment 5: Real data, dataset 2]{Data from dataset 2 with transformation matrix approximated with COLMAP or GPS-readings. BNs an abbreviation of Block-NeRF and the resulting metric score is averaged across the 4 NeRFs evaluations.}
...
COLMAP w/o optimizer, 4 BNs    &\cellcolor{green} 23.39594125 &\cellcolor{green} 0.794048 &\cellcolor{green} 0.32915525 & 00:08:45 \\
GPS w/ optimizer              & 18.165668 & 0.653362 & 0.597592 & 00:00:00 \\
GPS w/o optimizer             &\cellcolor{red} 13.796535 & 0.626601 & 0.719307 & 00:00:00 \\
GPS w/ optimizer, 4 BNs       & 18.401476 & 0.6379955 & 0.5449655 & 00:00:00 \\
GPS w/o optimizer, 4 BNs       & 14.37125725 &\cellcolor{red} 0.6192 &\cellcolor{red} 0.68332825 & 00:00:00 \\
\hline
\end{tabular}
\caption[Full results for experiment 5: Real data, dataset 3]{Data from dataset 3 with transformation matrix approximated with COLMAP or GPS-readings. BNs an abbreviation of Block-NeRF and the resulting metric score is averaged across the 4 NeRFs evaluations.}
