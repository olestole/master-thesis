...
\begin{table}[ht]
    ...
    \hline
    \end{tabularx}
    \caption[Overview of the default Nerfacto-big model's parameters]{An overview of the parameters in the Nerfacto-big model}
    \label{tab:nerfacto-big-parameter-overview}
\end{table}
