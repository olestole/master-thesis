...
\hline
0 & $\mathcal{N}(0, 0.0)$   & \cellcolor{green} 23.412970 & \cellcolor{green} 0.713507 & \cellcolor{red} 0.320640 & \cellcolor{green} 24.831890 & \cellcolor{green} 0.824606 & \cellcolor{red} 0.102266 \\
...
6 & $\mathcal{N}(0, 3.0^2)$ & \cellcolor{red} 16.662760 & \cellcolor{red} 0.408036 & \cellcolor{green} 0.637326 & \cellcolor{red} 15.709220 & \cellcolor{red} 0.344876 & \cellcolor{green} 0.612587 \\
\hline
& & \multicolumn{6}{c}{\textbf{Baseline \textbf{without} camera optimizer}} \\
\hline
& & \multicolumn{3}{c}{\textbf{Baseline segments}} & \multicolumn{3}{c}{\textbf{Shorter segments}} \\
\hline
0 & $\mathcal{N}(0, 0.0)$   & \cellcolor{green} 24.702831 & \cellcolor{green} 0.792646 & \cellcolor{red} 0.179289 & \cellcolor{green} 25.677803 & \cellcolor{green} 0.861634 & \cellcolor{red} 0.076989 \\
...
6 & $\mathcal{N}(0, 3.0^2)$ & \cellcolor{red} 16.322678 & \cellcolor{red} 0.385614 & \cellcolor{green} 0.647966 & \cellcolor{red} 15.077240 & \cellcolor{red} 0.362973 & \cellcolor{green} 0.698665 \\
\hline
\end{tabular}
...
\textbf{Description} & \textbf{PSNR $\uparrow$} & \textbf{SSIM $\uparrow$} & \textbf{LPIPS $\downarrow$} \\
\hline
COLMAP with optimizer    &\cellcolor{green} 23.486408 & 0.864474 & 0.421610 \\
COLMAP without optimizer & 22.640327 &\cellcolor{green} 0.865871 &\cellcolor{green} 0.401821 \\
GPS with optimizer       & 21.741020 & 0.849057 & 0.422538 \\
GPS without optimizer    &\cellcolor{red} 21.625042 &\cellcolor{red} 0.847604 &\cellcolor{red} 0.422631 \\
\hline
\end{tabular}
